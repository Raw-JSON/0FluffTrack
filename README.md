...
### 🤖 Transparency & AI
Core architecture and UI/UX logic were generated by **Gemini AI**. You can find the master prompt used to conceptualize this project in `PROMPT.md`. This allows anyone to recreate, study, or fork the logic using any modern LLM.
